...
export function createMarine(scene:THREE.Scene,world:RAPIER.World){
 ...
 reset();return {position,velocity,group,collider,stop(){speed=0;velocity.set(0,0,0);},get piloting(){return piloting;},get health(){return health;},get landed(){return Math.abs(speed)<1.2;},board,tryBoard:board,tryExit,exitPosition:tryExit,step,update:step,render,reset,restoreAt,setPatrolDefeated,stepPatrol,hit,
