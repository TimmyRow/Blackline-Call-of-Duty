...
export function renderRatio(touch,width,height,dpr=1,scale=1){return Math.min(dpr,touch?1:1.5,Math.sqrt((touch?950000:3686400)/Math.max(1,width*height)))*scale;}
